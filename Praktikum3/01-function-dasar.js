...
console.log("Hasil 1:", kalkulator(10, "+", 5)); // 15
console.log("Hasil 2:", kalkulator(10, "-", 5)); // 5
console.log("Hasil 3:", kalkulator(10, "*", 5)); // 50
console.log("Hasil 4:", kalkulator(10, "/", 2)); // 5
console.log("Hasil 5:", kalkulator(10, "/", 0)); // error